...
final class DLCons {
    ...
    static final class DBCons {
        ...
        static final String TB_COMPLETE = "complete_info";
        ...
        static final String TB_TASK_SQL_CREATE = "CREATE TABLE " +
                ...
                DBCons.TB_TASK_CURRENT_BYTES + " BIGINT, " +
                DBCons.TB_TASK_TOTAL_BYTES + " BIGINT)";
        static final String TB_THREAD_SQL_CREATE = "CREATE TABLE " +
                DBCons.TB_THREAD + "(" +
                BaseColumns._ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " +
                DBCons.TB_THREAD_URL_BASE + " CHAR, " +
                DBCons.TB_THREAD_START + " BIGINT, " +
                DBCons.TB_THREAD_END + " BIGINT, " +
                DBCons.TB_THREAD_ID + " CHAR)";
        static final String TB_COMPLETE_SQL_CREATE = "CREATE TABLE " +
                DBCons.TB_COMPLETE + "(" +
                BaseColumns._ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " +
                DBCons.TB_TASK_URL_BASE + " CHAR, " +
                DBCons.TB_TASK_URL_REAL + " CHAR, " +
        ...
        static final String TB_THREAD_SQL_UPGRADE = "DROP TABLE IF EXISTS " +
                DBCons.TB_THREAD;
        static final String TB_COMPLETE_SQL_UPGRADE = "DROP TABLE IF EXISTS " +
                DBCons.TB_COMPLETE;
    }
}