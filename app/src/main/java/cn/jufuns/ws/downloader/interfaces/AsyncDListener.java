...
public final class AsyncDListener implements IDListener {
                ...
                switch (msg.what){
                    ...
                    case OP_START:
                        realListener.onStart(bundle.getString(EXTRA_ARGS_1),
                                ...
                                bundle.getLong(EXTRA_ARGS_3));
                        break;
                    case OP_STOP:
                        realListener.onStop(bundle.getLong(EXTRA_ARGS_1));
                        break;
                    case OP_PROGRESS:
                        realListener.onProgress(bundle.getLong(EXTRA_ARGS_1));
                        break;
                    case OP_FINISH:
    ...
    public AsyncDListener(IDListener listener){
        mRef = new SoftReference<IDListener>(listener);
    }
    ...
    public void onStart(String fileName, String realUrl, long fileLength) {
        ...
        bundle.putLong(EXTRA_ARGS_3, fileLength);
    ...
    public void onProgress(long progress) {
        Bundle bundle = new Bundle();
        bundle.putLong(EXTRA_ARGS_1, progress);
